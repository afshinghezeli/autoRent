...
const defaultFAQItems: FAQItem[] = [
  {
    ...
    answer:
      "در صورت بروز هرگونه نقص فنی در خودرو، لطفاً با پشتیبانی ما تماس بگیرید. تیم فنی ما آماده ارائه خدمات و راهنمایی لازم می‌باشد.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answer:
      "بله، تمامی خودروهای اتورنت دارای بیمه شخص ثالث و بدنه می‌باشند. جزئیات پوشش بیمه در قرارداد اجاره قید شده است.",
  },
  {
    id: 4,
    question: "محدودیت کیلومتر در اجاره خودرو چقدر می باشد؟",
    answer:
      "محدودیت کیلومتر بسته به نوع قرارداد و مدت اجاره متفاوت است. جزئیات دقیق در هنگام رزرو اعلام خواهد شد.",
  },
];
...
export const FAQ: React.FC<FAQProps> = ({
  ...
  const handleKeyDown = useCallback(
    (event: KeyboardEvent<HTMLButtonElement>, id: number) => {
  ...
  return (
    <div className="faq__container">
      ...
      <div className="faq__header">
        {/* Subtitle */}
        <span className="faq__subtitle">پر تکرارترین سؤالاتی که پرسیدید</span>
        {/* Title */}
                      ...
                      <div className="faq__icon-container" aria-hidden="true">
                        {isActive ? (
                          <IconMinusSquare
                            width={20}
                            height={20}
                            className={`text-primary sm:w-6 sm:h-6 faq__icon faq__icon--rotated`}
                          />
                        ) : (
                          <IconAddSquare
                            width={20}
                            height={20}
                            className="text-primary sm:w-6 sm:h-6 faq__icon"
                          />
                        )}
                      </div>
                      {/* Title */}
                      <h6 className="faq__question-title">{item.question}</h6>
                    </button>
                    {/* Body */}
                    <div
                      className={`faq__content ${
                        isActive ? "faq__content--expanded" : ""
                      }`}
                      role="tabpanel"
